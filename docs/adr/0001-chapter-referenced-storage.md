...
长篇小说 Project 文档采用引用模式存储 Chapter——Project 仅存元数据和 chapterRefs，每章正文作为独立 MongoDB 文档。
...
**Decision**：Project 与 Chapter 为一对多关系，Chapter 以独立文档存储，通过 `projectId` 关联。Project 仅持有 `chapterRefs: [ObjectId]` 用于快速定位。
