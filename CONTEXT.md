...
> 最后更新：2026-05-27（Issue #20 Token 预计算完成后更新）
...
| 测试基础设施 | 已完成 (#4–#20) | 后端：Jest 30 + supertest — 18 套件 401 条（含 Unit + E2E）。前端：Vitest 2.1 + @vue/test-utils + happy-dom — 37 套件 416 条 | TDD 红→绿→重构完成。前后端合计 817 条测试，零回归 |
