...
> 最后更新：2026-06-04（Issue #22 章节管理与完结流程完成）
...
| 测试基础设施 | 已完成 (#4–#22) | 后端：Jest 30 + supertest — 19 套件 430 条（含 Unit + E2E，新增 Issue #21 专项 58 测试）。前端：Vitest 2.1 + @vue/test-utils + happy-dom — 38 套件 451 条（新增 #22 DraftingView.spec.ts 35 测试） | TDD 红→绿→重构完成。前后端合计 881 条测试 |
