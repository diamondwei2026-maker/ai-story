...
> 最后更新：2026-06-04（Issue #23 流式编辑器与审核面板集成完成）
...
| 测试基础设施 | 已完成 (#4–#23) | 后端：Jest 30 + supertest — 19 套件 430 条（含 Unit + E2E，新增 Issue #21 专项 58 测试）。前端：Vitest 2.1 + @vue/test-utils + happy-dom — 39 套件 574 条（新增 #23 EditorWorkspace 51 测试 + DraftingView 集成 14 测试） | TDD 红→绿→重构完成。前后端合计 1004 条测试 |
